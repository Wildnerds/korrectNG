...
import MaterialsAdvanceRequest from '@/components/contracts/MaterialsAdvanceRequest';
            ...
            {['funded', 'milestone_1_released', 'milestone_2_released'].includes(escrow.status) && (
              <div className="mt-6 bg-white rounded-xl p-6 shadow-sm">
                ...
                <p className="text-sm text-brand-gray mb-4">
                  Need additional funds for materials? Request an advance from the escrow balance.
                  The customer will review and approve your itemized request.
                </p>
                ...
                <MaterialsAdvanceRequest
                  escrowId={escrow._id as string}
                  remainingBalance={(escrow.fundedAmount || 0) - (escrow.releasedAmount || 0) - (escrow.refundedAmount || 0)}
                  onSuccess={fetchData}
                />
              </div>
            )}
