        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <a href="mailto:hello@korrectng.com" className="text-brand-green hover:underline">
                hello@korrectng.com
              </a>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <a href="mailto:support@korrectng.com" className="text-brand-green hover:underline">
                support@korrectng.com
              </a>
            </div>

            <div className="bg-white p-6 rounded-lg shadow-sm">
              <h3 className="font-semibold text-gray-900 mb-2">Business</h3>
              <p className="text-gray-600 text-sm mb-2">Partnership opportunities:</p>
              <a href="mailto:business@korrectng.com" className="text-brand-green hover:underline">
                business@korrectng.com
              </a>
            </div>
          ...
          <div className="md:col-span-2">
              ...
              {status === 'success' ? (
                <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-8 rounded-lg text-center">
                  ...
                  <button
                    ...
                    className="mt-4 text-brand-green hover:underline text-sm"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full bg-brand-green text-white py-3 rounded-lg font-medium hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-600 text-sm">
                ...
                <a href="/faq" className="text-brand-green hover:underline">
                  Check our FAQ
                </a>
              </p>
            </div>
